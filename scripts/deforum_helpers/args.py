                ...
                with gr.Column(variant='compact'):
                    ...
                    with gr.Row(visible=False) as interp_existing_video_row:
                        ...
                        with gr.Accordion('Interpolate an existing video', open=False) as interp_existing_video_accord:
                            ...
                            frame_interpolation_slow_mo_enabled.change(set_interp_out_fps, inputs=[frame_interpolation_x_amount, frame_interpolation_slow_mo_enabled, frame_interpolation_slow_mo_amount, in_vid_fps_ui_window], outputs=out_interp_vid_estimated_fps)
