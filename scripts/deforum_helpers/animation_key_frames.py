...
class DeformAnimKeys():
    def __init__(self, anim_args, seed=-1):
        ...
        self.center_x_series = self.fi.get_inbetweens(self.fi.parse_key_frames(anim_args.center_x))
        self.center_y_series = self.fi.get_inbetweens(self.fi.parse_key_frames(anim_args.center_y))
