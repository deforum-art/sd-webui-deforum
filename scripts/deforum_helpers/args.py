...
def setup_deforum_setting_dictionary(self, is_img2img, is_extension = True):
        ...
        with gr.Tabs():
            ...
            with gr.TabItem('Keyframes'): #TODO make a some sort of the original dictionary parsing
                ...
                with gr.Row(variant='compact'):
                    ...
                    # optical_flow_cadence = gr.Checkbox(label="Optical flow cadence (3D only)", value=False, interactive=True, elem_id='optical_flow_cadence')
                ...
                with gr.Tabs(elem_id='motion_noise_etc'):
                    ...
                    with gr.TabItem('Coherence', open=False) as coherence_accord:
                        ...
                        with gr.Row(variant='compact'):
                            ...
                            optical_flow_cadence = gr.Checkbox(label="Optical flow cadence (3D Only)", value=False, visible=False, interactive=True, elem_id='optical_flow_cadence')
                        with gr.Row(variant='compact'):
    ...
    animation_mode.change(fn=disble_3d_related_stuff, inputs=animation_mode, outputs=optical_flow_cadence) 
