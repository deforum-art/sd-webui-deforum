...
class DeformAnimKeys():
    def __init__(self, anim_args, seed=-1):
        ...
        self.rotation_center_x_series = self.fi.get_inbetweens(self.fi.parse_key_frames(anim_args.rotation_center_x))
        self.rotation_center_y_series = self.fi.get_inbetweens(self.fi.parse_key_frames(anim_args.rotation_center_y))
