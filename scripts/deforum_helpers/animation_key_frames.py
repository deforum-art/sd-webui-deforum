...
class DeformAnimKeys():
    def __init__(self, anim_args):
        ...
        self.center_x_series = get_inbetweens(parse_key_frames(anim_args.center_x), anim_args.max_frames)
        self.center_y_series = get_inbetweens(parse_key_frames(anim_args.center_y), anim_args.max_frames)
