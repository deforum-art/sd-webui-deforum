...
def DeforumArgs():
    ...
    full_res_mask_padding = 0 #@param
    mask_frame_noise = False #@param {type:"boolean"}
...
def setup_deforum_setting_dictionary(self, is_img2img, is_extension = True):
    ...
    with gr.Tab('Init'):
        ...
        with gr.Row():
            ...
            mask_frame_noise = gr.Checkbox(label="mask_frame_noise", value=d.mask_frame_noise, interactive=True)
