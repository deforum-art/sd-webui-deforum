...
def DeforumAnimArgs():
    ...
    depth_algorithm = 'Midas+AdaBins' # ['Midas+AdaBins','Midas-3-Hybrid','Midas-3.1-BeitLarge', 'AdaBins','Zoe', 'Leres']
    midas_weight = 0.2 
                        ...
                        with gr.Accordion('Depth Warping & FOV', visible=False, open=False) as depth_3d_warping_accord:
                            with gr.TabItem('Depth Warping'): 
                                with gr.Row(variant='compact'):
                                    ...
                                    depth_algorithm = gr.Dropdown(label="Depth Algorithm", choices=['Midas+AdaBins','Midas-3-Hybrid','Midas-3.1-BeitLarge', 'AdaBins','Zoe', 'Leres'], value=da.depth_algorithm, type="value", elem_id="df_depth_algorithm", interactive=True)
