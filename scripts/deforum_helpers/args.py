...
def fragment_shader():
    return """// Winning shader made at Revision 2022 Shader Showdown Quarter-final
...
def process_args(args_dict_main, run_id):
    ...
    return args_loaded_ok, root, args, anim_args, video_args, parseq_args, loop_args, controlnet_args, glsl_args
