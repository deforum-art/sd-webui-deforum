...
def DeforumArgs():
    ...
    # Enables use of sampler scheduling in keyframes tab
...
def setup_deforum_setting_dictionary(self, is_img2img, is_extension = True):
    ...
    with gr.Tab('Keyframes'):
        ...
        # Sampler Scheduling
        i38 = gr.HTML("<p style=\"margin-bottom:0.75em\">To enable sampler schedule check 'enable sampler scheduling' above</p>")
        with gr.Row():
