...
def get_keys_to_exclude():
    return ["n_batch", "seed_enable_extras", "filename_format", "scale", "subseed", "subseed_strength", "init_sample",
        "noise_mask", "seed_internal", "perlin_w", "perlin_h", "mp4_path", "image_path", "output_format","outdir"]
