...
class ControlNetKeys():
    def __init__(self, anim_args, controlnet_args):
        ...
        self.cn_1_guidance_start_schedule_series = self.fi.get_inbetweens(self.fi.parse_key_frames(controlnet_args.cn_1_guidance_start))
        self.cn_1_guidance_end_schedule_series = self.fi.get_inbetweens(self.fi.parse_key_frames(controlnet_args.cn_1_guidance_end))
        ...
        self.cn_5_guidance_end_schedule_series = self.fi.get_inbetweens(self.fi.parse_key_frames(controlnet_args.cn_5_guidance_end))
