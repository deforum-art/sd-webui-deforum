...
def run_deforum(*args, **kwargs):
    ...
    print("\033[4;33mDeforum extension for auto1111 webui, v2.1b\033[0m")
    args_dict['self'] = None
    args_dict['p'] = p
    ...
    if video_args.make_gifski:
        make_gifski_gif(imgs_raw_path = args.outdir, imgs_batch_id = args.timestring, fps = video_args.fps, models_folder = root.models_path)
