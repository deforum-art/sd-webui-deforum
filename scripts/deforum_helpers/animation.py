...
def anim_frame_warp_2d(prev_img_cv2, args, anim_args, keys, frame_idx):
    ...
    rotation_center_x = keys.rotation_center_x_series[frame_idx]
    rotation_center_y = keys.rotation_center_y_series[frame_idx]
    center_point = (args.W * rotation_center_x, args.H * rotation_center_y)
