...
class DeformAnimKeys():
    def __init__(self, anim_args):
        ...
        self.sigma_schedule = get_inbetweens(parse_key_frames(anim_args.sigma_schedule), anim_args.max_frames)
        self.amount_schedule = get_inbetweens(parse_key_frames(anim_args.amount_schedule), anim_args.max_frames)
        self.threshold_schedule = get_inbetweens(parse_key_frames(anim_args.threshold_schedule), anim_args.max_frames)
