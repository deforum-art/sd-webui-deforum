...
def DeforumAnimArgs():
    ...
    normalize_depth = 'Normalize' #@param {type:"string"}
            ...
            with gr.Tab('Motion') as motion_tab:
                ...
                with gr.Accordion('Depth Warping & FOV', visible=False, open=False) as depth_3d_warping_accord:
                    with gr.Tab('Depth Warping'): 
                        ...
                        with gr.Row(variant='compact'):
                            normalize_depth = gr.Radio(['Normalize', 'Remap and clip'], label="Depth normalization", value=da.normalize_depth, elem_id="normalize_depth")
                        with gr.Row(variant='compact'):
...
anim_args_names =   str(r'''animation_mode, max_frames, border,
                        ...
                        use_depth_warping, midas_weight, normalize_depth,
